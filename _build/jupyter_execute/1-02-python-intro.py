...
# 
# This tutorial introduces basic Python syntax, commands and variable types. We will be using the Anaconda distribution of Python. See installation instructions [here](software-installation/README.md).
# 
